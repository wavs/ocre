...
\label{prt:ce_qu_on_a_fait}
	...
	\label{cha:site_web}
		Le site web\footnote{\emph{http://huge.ocre.free.fr}} est la premi\`ere chose que verra l'utilisateur potentiel. Il devra donc \^etre \`a la fois attirant et bien ordonn\'e. Le site contient %% FIX %% pages:
		\begin{itemize}
			...
			\item Une page de t\'el\'echargement qui listera chronologiquement tout ce qu'on a cr\'e\'e, c'est \'a dire nos sources, les \'ex\'ecutables et les rapports de soutenance.
