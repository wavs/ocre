...
de caractères d'après une image parfaite, à savoir une image prétraitée.
...
d'une composante connexe. Elle permet alors de mettre à jour le nombre
de pixels la composant ainsi que ses coordonnées minimum et maximum qui
