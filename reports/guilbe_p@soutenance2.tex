...
Preuve exp\'erimentale produite \'a partir d' une image multifonte,
multicouleur, mulicolonne:

 Comme vous pouvez le voir sur ces images, il est \'evident qu'il y'a une
 nette diff\'erence entre des images avec un texte mal orient\'e et normal.
...
de zone ou l'histogramme atteint 0 en ordonn\'e est beaucoup plus faible
...
\'a z\'ero est bien plus grand avec un angle de un degr\'ee. Ici environ 18.
...
ci-dessus semble bien march\'e en th\'eorie.
...
la vertical. On la soustrait \'a 90 degr\'e si elle est positive, on
...
Les extremums locaux de la courbe sont beaucoup moins \'elev\'es en
termes de valeurs. Ce qui a pour cons\'equence, une pente peu \'elev\'ee et donc un angle tres \'elev\'e.

% mettre l'image histo_pent_noangle.jpg
% commentaire image histo_pent_noangle

Les extremums locaux de la courbe sont beaucoup plus \'elev\'es en
termes de valeurs que ceux de la courbe pr\'ec\'edente. Ce qui a pour
cons\'equence, une pente tres \'elev\'ee et donc un angle tres faible.

Le probl\'eme avec cette technique, et le manque de pr\'ecision autour
de l'angle nul, et des bruit trop important produit par des lignes,
tableaux, ou images impromptus.

Nous avons pourtant retenus cette technique pour cette soutenance, car
donnant lieu \'a des r\'esultat plus probant que la m\'ethode expos\'ee
plus haut.
...
\subsection{ Reduction de l'image }
 ...
 d'angle, nous r\'eduisons l'image de sorte qu'il y est le moins de
 pertes d'information n\'ecessaire \'a cette derni\'ere. A titre
 d'exemple une image au format A4 en 75 dpi, a une taille approximative
 de 900 par 700. Les caract\`eres pr\'esent dans cette image ont une
 taille en pixel d'\'a peu pr\'es 8 pixel. Il faut donc ne pas trop
 r\'eduire l'image, environ 40 pourcent de la taille original. Au
 contraire pour une image de plus haute d\'efinition, par exemple 600
 dpi, Il est n\'ecessaire de r\'eduire l'image \'a au moins 5 pourcent
 de la taille original. A titre d'exemple, la rotation d'une image
 r\'eduite \'a 5 pourcent prend environ 0,05 seconde sur les machines du
 pie, alors qu'elle prend plus de 30 seconde pour une image en 600 dpi.

%% reduceimage20percent75dpit.jpg
Une image reduite.

Remarque, il est int\'erressant de voir qu'une image r\'eduite comporte
moins de bruit, qui fausserai l'avanc\'ee de l'algo de reconnaissance
des plages nulle.
